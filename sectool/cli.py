...
def build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument("--sarif", action="store_true", help="Emit findings as SARIF 2.1.0 (for CI)")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    logger = setup_logging(args.verbose, json_format=args.json or args.sarif)
